            ...
            >
              <div className="space-y-10">
                ...
                <div className="space-y-4 pt-4">
                  <button onClick={() => navigate('/ar')} className="w-full py-5 bg-accent text-primary rounded-[2rem] font-black text-xs uppercase tracking-widest flex items-center justify-center gap-3 hover:brightness-110 shadow-sm transition-all active:scale-95">
