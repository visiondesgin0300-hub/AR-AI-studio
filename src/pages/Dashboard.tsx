...
import { Search, BookOpen, Clock, ChevronRight, Compass, MapPin, Layers, MessageCircle, Gamepad2 } from 'lucide-react';
  ...
  return (
    <div className="space-y-16 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-6xl mx-auto pb-20">
      ...
      <section className="official-card p-8 md:p-10 bg-white dark:bg-slate-900 space-y-8">
        ...
        {/* Game info (read-only) */}
        <div className="flex items-center gap-3 px-5 py-3.5 rounded-2xl bg-primary/5 dark:bg-white/5 border border-primary/10 dark:border-white/10">
