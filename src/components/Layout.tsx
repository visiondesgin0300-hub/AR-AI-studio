...
import { Home, BookOpen, Map, Compass, LogOut, User as UserIcon, Award, ShieldCheck, Brain, Bell, Check, Info, AlertTriangle, Languages, Camera, Search, HelpCircle, MessageCircle, QrCode, X, Printer, Sparkles, Cpu, Eye, FlaskConical, Radar } from 'lucide-react';
          ...
          {showCameraMenu && (
            ...
            >
              {[
                ...
                { icon: Radar,       labelAr: 'ماسح الفجوات AR',    labelEn: 'Gap Scanner AR',      path: '/gap-scanner',      accent: false, green: true,  adminOnly: false },
